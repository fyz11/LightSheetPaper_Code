...
# =============================================================================
    ...
    for emb_ii in np.arange(n_embs):
        ...
        fig.savefig(os.path.join(saveplotfolder_final, 'PCA_pullback_xy_pts_%s.svg' %(uniq_embryo[emb_ii])), 
                    bbox_inches='tight', 
                    dpi=300)
        plt.show()
    ...
    for emb_ii in np.arange(n_embs):
        ...
        for cc_ii in np.arange(len(complex_pts_all)):
            ...
            fig.savefig(os.path.join(saveplotfolder_final_region, 'PCA_pullback_xy_pts_%s_Grp%s.svg' %(uniq_embryo[emb_ii], str(cc_ii))), 
                        bbox_inches='tight', 
                        dpi=300)
            plt.show()
    ...
    for emb_ii in np.arange(n_embs):
        ...
        fig.savefig(os.path.join(saveplotfolder_final, 'PCA_pullback_xy_pts_tracks_%s.svg' %(uniq_embryo[emb_ii])), bbox_inches='tight')
        plt.show()
    ...
    for emb_ii in np.arange(n_embs):
        ...
        for cc_ii in np.arange(len(complex_pts_all)):
            ...
            fig.savefig(os.path.join(saveplotfolder_final_region, 'PCA_pullback_xy_pts_tracks_%s_Grp%s.svg' %(uniq_embryo[emb_ii], str(cc_ii))), 
                        bbox_inches='tight', 
                        dpi=300)
            plt.show()
