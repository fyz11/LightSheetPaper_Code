...
#                                                                                                                          growth_correction=growth_correction)
                        ...
                        """
                        save_strain_rate_file = os.path.join(savedefmapfolder, 'deformation_strain_rate_'+unwrapped_condition+'.mat')
                        ...
                        saveplotfolder = os.path.join(master_plot_save_folder, unwrapped_condition+'_smooth_lam100_p0.5_anterior_smooth', analyse_stage)
                        ...
                        for frame in range(len(pts_ve)-1)[:]:
                            ...
                            ax.imshow(heat_delta_area_ve_viz, cmap='coolwarm_r', vmin=-0.01, vmax=0.01)
...
#                                        [centroid_2D_rot[kkk,0]- length_theta[kkk]*centroid_2D_secvec_rot[kkk,0], centroid_2D_rot[kkk,0]+length_theta[kkk]*centroid_2D_secvec_rot[kkk,0] ], 'k-')
                            ...
                            for kkk in range(1*40, len(centroid_2D_rot)):
                                ...
                                w_ll = w_VE[frame,kkk,1]
                                v_ll = v_VE[frame, kkk, :, 1] # elongation direction. ?
...
#                                        [centroid_2D_rot[kkk,0]- length_theta[kkk]*centroid_2D_secvec_rot[kkk,0], centroid_2D_rot[kkk,0]+length_theta[kkk]*centroid_2D_secvec_rot[kkk,0] ], 'k-')
                            ...
                            for kkk in range(1*40, len(centroid_2D_rot)):
                                ...
                                ll = min_edge_square_grid[kkk]
                                w_ll =w_Epi[frame,kkk,1]
                                v_ll = v_Epi[frame, kkk, :, 1] # elongation direction. ?
