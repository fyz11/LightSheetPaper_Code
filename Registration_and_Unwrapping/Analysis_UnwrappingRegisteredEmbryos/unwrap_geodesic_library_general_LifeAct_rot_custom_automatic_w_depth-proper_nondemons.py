...
#    mastersavefolder = '/media/felix/My Passport/Shankar-2/All_Depth_Unwrap-Demons'
    mastersavefolder = '/media/felix/My Passport/Shankar-2/All_Depth_Unwrap-NonDemons2'
...
#                    proj_dir_ve_epi = proj_dir_ve_epi / (np.nanmin(np.linalg.norm(proj_dir_ve_epi, axis=-1)) + 1e-8) # this is the min? 
#                    proj_dir_ve_epi = proj_dir_ve_epi / (20 + 1e-8)
