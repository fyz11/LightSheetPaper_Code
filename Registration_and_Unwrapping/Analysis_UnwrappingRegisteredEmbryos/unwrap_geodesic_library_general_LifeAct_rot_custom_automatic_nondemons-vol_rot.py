...
#            embryo_folder_alt = embryo_folder.replace(rootfolder, '/media/felix/My Passport/Srinivas4/Hex')
            embryo_im_folder = [os.path.join(embryo_folder, name) for name in os.listdir(embryo_folder) if ('step5_' in name or 'step5tf_' in name or 'step5tf-' in name or 'step5-' in name) and os.path.isdir(os.path.join(embryo_folder, name))]
#            embryo_im_folder = np.hstack([os.path.join(embryo_folder, name) for name in os.listdir(embryo_folder) if ('step6_' in name or 'step6tf_' in name or 'step6tf-' in name or 'step6-' in name) and os.path.isdir(os.path.join(embryo_folder, name))])

            if len(embryo_im_folder) == 0:
                embryo_im_folder = np.hstack([os.path.join(embryo_folder, name) for name in os.listdir(embryo_folder) if ('step4_' in name or 'step4tf_' in name or 'step4tf-' in name or 'step4-' in name) and os.path.isdir(os.path.join(embryo_folder, name))])
            else:
