...
#    divfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\Annotated_Cell_Divisions\\div_polar_Matt_edit_refine_ms_edit_11_05.csv'
...
#     divfile = 'L455_E3 EDITED BINARY/L455_E3_div_polar_rectangular_only_refine_MS_p_edit4_refine3.csv'
    ...
    tiffile = 'C:\\Users\\fyz11\\Documents\\Work\\Projects\\Shankar-AVE_Migration\\Annotation\\Curations\\L455_Emb2\\2021-04-21\\26Mar_up2_binary-2x-direct_MS_edit3.tif'
    trackfile = 'C:\\Users\\fyz11\\Documents\\Work\\Projects\\Shankar-AVE_Migration\\Annotation\\Curations\\L455_Emb2\\2021-04-21\\refine\\26Mar_up2_binary-2x-direct_MS_edit3-manual_polar_distal_corrected_nn_tracking-full-dist30.csv'
#    divfile = 'L455_E3 EDITED BINARY/L455_E3_div_polar_rectangular_only_refine_MS_p_edit3_refine2.csv'
    divfile = 'C:\\Users\\fyz11\\Documents\\Work\\Projects\\Shankar-AVE_Migration\\Annotation\\Curations\\L455_Emb2\\2021-04-21\\25Mar_L455_E2_div_polar_MS_Dec_edit3_correct.csv'
...
#    matfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\cell_tracks_w_ids_Holly_polar_distal_corrected_nn_tracking-full-dist30.mat'
    ...
    matfile = 'C:\\Users\\fyz11\\Documents\\Work\\Projects\\Shankar-AVE_Migration\\Annotation\\Curations\\L455_Emb2\\2021-04-21\\refine\\cell_tracks_w_ids_26Mar_up2_binary-2x-direct_MS_edit3-manual_polar_distal_corrected_nn_tracking-full-dist30.mat'
...
#    cellfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\cells_L491_final_version_polar_2nd_edit_merge.tif'
    ...
    cellfile = 'C:\\Users\\fyz11\\Documents\\Work\\Projects\\Shankar-AVE_Migration\\Annotation\\Curations\\L455_Emb2\\2021-04-21\\refine\\cells_26Mar_up2_binary-2x-direct_MS_edit3.tif'
...
#        daughter_spixels = np.setdiff1d(np.unique(cell_img[div_time_matt+1, cell_img[div_time_matt]==mother_spixel]), 0)
#        
...
#    saveplotfolder = 'debug_L491_div_parsing_Matt_edit-auto_refine'
#    mkdir(saveplotfolder)
    
#    div_time, (mother_tra_ids, mother_xy), (daughter1_tra_ids, daughter1_xy), (daughter2_tra_ids, daughter2_xy) 
    
    mother_spixel_refine = cell_img[div_time.astype(np.int), 
                                    mother_xy[:,1].astype(np.int), 
                                    mother_xy[:,0].astype(np.int)]
    
    daughter_spixels_refine_1 = cell_img[div_time.astype(np.int)+1, 
                                         daughter1_xy[:,1].astype(np.int), 
                                         daughter1_xy[:,0].astype(np.int)]
    
    daughter_spixels_refine_2 = cell_img[div_time.astype(np.int)+1, 
                                         daughter2_xy[:,1].astype(np.int), 
                                         daughter2_xy[:,0].astype(np.int)]
    
    refined_div_times = (np.hstack([div_time[:,None].astype(np.int), 
                                    mother_xy, 
                                    daughter1_xy, 
                                    daughter2_xy,
                                    mother_spixel_refine[:,None], 
                                    daughter_spixels_refine_1[:,None],
                                    daughter_spixels_refine_2[:,None]]))
    
    refined_div_times = refined_div_times.astype(np.int)
...
# =============================================================================
    ...
    """
#    savematfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\Annotated_Cell_Divisions\\cell_tracks_w_ids_Holly_polar_distal_corrected_nn_tracking-full-dist30_cell-div-refined-Matt_11-05.mat'
#    savematfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\Annotated_Cell_Divisions\\cell_tracks_w_ids_Holly_polar_distal_corrected_nn_tracking-full-dist30_cell-div-refined-Matt_11-05.mat'
    savematfile = os.path.join(saveoutfolder, 'cell_tracks_w_ids_'+os.path.split(trackfile)[-1].split('-manual')[0]+'_div-refine_v2.mat')
...
#    savecsvtrackfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\Annotated_Cell_Divisions\\cell_tracks_w_ids_Holly_polar_distal_corrected_nn_tracking-full-dist30_cell-div-refined-Matt_11-05.csv'
    savecsvtrackfile = os.path.join(saveoutfolder, 'cell_tracks_w_ids_'+os.path.split(trackfile)[-1].split('-manual')[0]+'_div-refine_v2.csv')
    ...
    """
#    savedivcsvfile = 'C:\\Users\\felix\\Documents\\PostDoc\\Shankar\\Annotated_Cell_Tracking\\Annotated_Cell_Divisions\\div_polar_Matt_edit_refine_11-05.csv'
    savedivcsvfile = os.path.join(saveoutfolder, base_fname+'_'+os.path.split(divfile)[-1]+'_refine_v2.csv')
